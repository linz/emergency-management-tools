let
  ...
  sentinel1WaterExtractionPoetryPackages =
    import ./flooding/sentinel1_water_extraction/poetryPackages.nix
      { inherit poetry2nix python; };
  sentinel2WaterExtractionPoetryPackages =
    import ./flooding/sentinel2_water_extraction/poetryPackages.nix
      { inherit poetry2nix python; };
